class Demo:
    ...
    def gun(cls):
        ...
        print(cls.Value1)              #Class variables accessed via class name  
        print(cls.Value2)                   #cls is parameter for class method
...
Demo.sun()                   #accessing static method, but its inside class so need class_name to access it.
